...
It naturally arises on wordnet generation tasks when extend approach is used, which will be talked about in detail in Section~\ref{sec:approaches_in_wordnet_generation}.
