...
The \emph{skip-gram model} introduced by \textcite{mikolov_efficient_2013} differs from the previous methods by predicting the surrounding words given the target word.
...
% TODO maybe a word about mnih

Let us turn our focus on \citetitle{bojanowski_enriching_2016}~\cite{bojanowski_enriching_2016}.
