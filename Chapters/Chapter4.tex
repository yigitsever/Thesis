...
Second, they introduced \emph{entropic regularization} which allowed them to use Sinkhorn-Knopp algorithm~\cite{sinkhornConcerning1967} to solve the linear assignment between word embeddings of the source and the target documents.
