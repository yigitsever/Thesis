...
\begin{table}[htbp]
    ...
    \begin{tabulary}{1.0\linewidth}{L L R R}
        ...
        \cmidrule(lr){2-4}
        \multirow{3}{*}{el}                    & fastText 1M   & 18117 & \textbf{31.15} \\
        ...
        \cmidrule(lr){2-4}
        \multirow{3}{*}{sq}                    & fastText 1M   & 4680  & \textbf{44.96} \\
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \includegraphics[width=\textwidth]{enro.eps}
        \caption{en - ro}%
        \label{subfig:enro}
    \end{subfigure}
    ~
    \begin{subfigure}[b]{0.45\linewidth}
        \includegraphics[width=\textwidth]{elro.eps}
        \caption{el - ro}%
        \label{subfig:elro}
    \end{subfigure}

    \begin{subfigure}[b]{0.45\linewidth}
        \includegraphics[width=\textwidth]{bgit.eps}
        \caption{bg - it}%
        \label{subfig:bgit}
    \end{subfigure}
