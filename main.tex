...
\usepackage{lscape} % for tables to span multiple pages (commenting months later don't know if it's necessary)
\usepackage{longtable} % for tables to span multiple pages
\newcommand{\overbar}[1]{\mkern 1.5mu\overline{\mkern-1.5mu#1\mkern-1.5mu}\mkern 1.5mu} % better top bar
\usepackage[autostyle=true]{csquotes} % Required to generate language-dependent quotes in the bibliography
\usepackage{pdfpages}
\usepackage{nameref} % refer to the name of sections
\newcommand*{\fullref}[1]{\hyperref[{#1}]{\autoref*{#1} \nameref*{#1}}} % One single link for the name and number ref
...
\usepackage{titlesec}
\titleformat{\chapter}[hang]{\normalfont\huge\bfseries\centering}{\thechapter.}{0.25em}{}
% \titleformat{\chapter}[hang]{\huge}{\thechapter}{1em}{}
\titlespacing{\chapter}{0pt}{-5em}{1em}
...
\usepackage{tabularx}
\usepackage{multirow}
\usepackage{graphicx} % tablesgenerator.com asked me to
...
\afterpage{\blankpage} % Include 2 blank pages
\afterpage{\blankpage} % For printing, remove for web upload
