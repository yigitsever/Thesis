...
\supervisor{Dr.~Gönenç \textsc{Ercan}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\department{\href{http://department.university.com}{Computer Engineering Department}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
%\group{\href{http://researchgroup.university.com}{Research Group Name}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
\faculty{\href{http://faculty.university.com}{Faculty Of Science and Engineering}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
Dictionaries catalog and describe the semantic information of a lexicon.
